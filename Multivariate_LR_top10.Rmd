...
Comfort_Q20<- Comfort_Q20[ , which(names(Comfort_Q20) %in% c("Charlson.Mild","Charlson.Severe","Frail","Antibiotics","Clopidogrel","Charlson.Moderate","Anticoagulant","Replacement", "Loop.diuretics","MRA","Outcome_variable"))]
```
